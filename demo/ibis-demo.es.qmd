...
Y las renderizamos la expresión abstracta:
...
Y Polars con el método `to_polars()`, si ustedes lo tienen installado.
...
Y cuando quiere ver el SQL, tenemos el método `to_sql`:
...
Para nuestros análisis final, vamos a limipiar unas cosas como seleccionando solo titulos con el tipo "película" y desechando las películas adultas.
...
Y filtramos titulos con votos menos que uno millón.
