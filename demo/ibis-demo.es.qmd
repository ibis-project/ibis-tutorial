...
!curl -OLsS 'https://storage.googleapis.com/ibis-tutorial-data/imdb/2024-03-22/imdb_ratings_basics.parquet'
...
basics = con.read_parquet("imdb_title_basics.parquet", table_name="ibis_title_basics")
```
